...
<img src='./img/register.PNG' alt='Register page' height='963px' width='1290px'></img>

<p>Log in to view available sessions.</p>
<img src='./img/login.PNG' alt='Login page' height='963px' width='1290px'></img>
<img src='./img/session-list.PNG' alt='Sessions list page' height='963px' width='1290px'></img>

<p>To create a session, simply click 'create a session' and fill in the details.</p>
<img src='./img/add-session.PNG' alt='Add session page' height='963px' width='1290px'></img>

<p>If you are not the creator of the session, the only option will be to join the session.</p>
<img src='./img/join.PNG' alt='Session join page' height='963px' width='1290px'></img>
...
<img src='./img/paid.PNG' alt='Mark yourself as paid' height='963px' width='1290px'></img>
...
<img src='./img/session.PNG' alt='Admin session page' height='963px' width='1290px'></img>
...
<img src='./img/profile.PNG' alt='Profile page' height='963px' width='1290px'></img>
